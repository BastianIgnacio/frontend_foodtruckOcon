...
export default function ProductosVitrinaPage3() {
  ...
  useEffect(() => {
    axios.get('/api/products/public', { params: { carousel3_only: true } })
  ...
  if (!products.length) {
    return (
      <Box sx={{ height: '100vh', bgcolor: '#0a0a0a', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: 2 }}>
        ...
        <Typography sx={{ color: 'rgba(255,255,255,0.4)' }}>Agrega productos desde el panel de administración → Carrusel 3</Typography>
      </Box>
    )
  }
